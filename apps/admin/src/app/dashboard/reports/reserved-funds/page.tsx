...
const columns = [
  columnHelper.accessor("type", {
    ...
    header: () => (
      <ColumnHeader i18nKey="dashboard.reports.sections.reserved-funds-by-user.header.type" />
    ),
  }),
  columnHelper.accessor("description", {
    ...
    cell: (info) => info.getValue() || "-",
    header: () => (
      <ColumnHeader i18nKey="dashboard.reports.sections.reserved-funds-by-user.header.description" />
    ),
  }),
  columnHelper.accessor("startDate", {
    ...
    cell: (info) => info.getValue(),
    header: () => (
      <ColumnHeader i18nKey="dashboard.reports.sections.reserved-funds-by-user.header.start" />
    ),
  }),
  columnHelper.accessor("endDate", {
    ...
    cell: (info) => info.getValue(),
    header: () => (
      <ColumnHeader i18nKey="dashboard.reports.sections.reserved-funds-by-user.header.finish" />
    ),
  }),
  columnHelper.accessor("status", {
    ...
    cell: (info) => info.getValue(),
    header: () => (
      <ColumnHeader i18nKey="dashboard.reports.sections.reserved-funds-by-user.header.state" />
    ),
  }),
  columnHelper.accessor("amount", {
    ...
    header: () => (
      <ColumnHeader i18nKey="dashboard.reports.sections.reserved-funds-by-user.header.ammount" />
    ),
  }),
  columnHelper.display({
    id: "actions",
    header: () => (
      <ColumnHeader i18nKey="dashboard.reports.sections.reserved-funds-by-user.header.actions" />
    ),
        ...
        <div className="flex flex-row flex-wrap gap-4">
          ...
          <Button className="h-max self-end" onClick={() => refetch()}>
            <p className="flex-1 text-lg font-light">
              {
                values[
                  "dashboard.reports.sections.reserved-funds-by-user.search-button"
                ]
              }
            </p>
          </Button>
        ...
        <div className="flex flex-row justify-between">
          <div>
            <p>
              {
                values[
                  "dashboard.reports.sections-reserved-funds-by-user.user.label"
                ]
              }
              :{" "}
            ...
            <p>
              {
                values[
                  "dashboard.reports.sections-reserved-funds-by-user.period.label"
                ]
              }
              :{" "}
              {filters.startDate
...
const columnsDetails = [
  ...
  columnHelperDetails.accessor("date", {
    ...
    cell: (info) => info.getValue(),
    header: () => (
      <ColumnHeader i18nKey="dashboard.reports.sections.reserved-funds-by-user.details.date" />
    ),
  }),
